 ...
 * implementación concreta (AxiosAuthRepository). Es el "cableado" manual de
 * dependencias: el resto de la app importa `authUseCase` y nunca instancia
 * AuthUseCase ni AxiosAuthRepository directamente.
 */
