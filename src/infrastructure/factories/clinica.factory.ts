...
export const notificacionesUseCase = new CrudUseCase<Notificacion>(
  new AxiosCrudRepository<Notificacion>('/notificaciones/'),
)

export const notificacionRepository = new AxiosNotificacionRepository()
